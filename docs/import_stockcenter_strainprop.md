## import stockcenter strainprop

load stockcenter strain properties data
...
```
import stockcenter strainprop [flags]
```
...
```
  ...
  -h, --help                          help for strainprop
  -i, --strainprop-input string       csv file with strain property data
```
