...
// checks if the RequestSingleSelectFieldUpdateField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestSingleSelectFieldUpdateField{}
...
// NewRequestSingleSelectFieldUpdateField instantiates a new RequestSingleSelectFieldUpdateField object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRequestSingleSelectFieldUpdateField() *RequestSingleSelectFieldUpdateField {
	this := RequestSingleSelectFieldUpdateField{}
	return &this
}

// NewRequestSingleSelectFieldUpdateFieldWithDefaults instantiates a new RequestSingleSelectFieldUpdateField object
...
func (o *RequestSingleSelectFieldUpdateField) GetName() string {
...
func (o *RequestSingleSelectFieldUpdateField) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *RequestSingleSelectFieldUpdateField) SetName(v string) {
	o.Name = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *RequestSingleSelectFieldUpdateField) GetType() Type712Enum {
...
// and a boolean to check if the value has been set.
func (o *RequestSingleSelectFieldUpdateField) GetTypeOk() (*Type712Enum, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *RequestSingleSelectFieldUpdateField) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *RequestSingleSelectFieldUpdateField) SetType(v Type712Enum) {
	o.Type = &v
}
...
type NullableRequestSingleSelectFieldUpdateField struct {
	value *RequestSingleSelectFieldUpdateField
	isSet bool
}

func (v NullableRequestSingleSelectFieldUpdateField) Get() *RequestSingleSelectFieldUpdateField {
	return v.value
}

func (v *NullableRequestSingleSelectFieldUpdateField) Set(val *RequestSingleSelectFieldUpdateField) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestSingleSelectFieldUpdateField) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestSingleSelectFieldUpdateField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestSingleSelectFieldUpdateField(val *RequestSingleSelectFieldUpdateField) *NullableRequestSingleSelectFieldUpdateField {
	return &NullableRequestSingleSelectFieldUpdateField{value: val, isSet: true}
}

func (v NullableRequestSingleSelectFieldUpdateField) MarshalJSON() ([]byte, error) {
