...
// checks if the FileFieldField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileFieldField{}
...
// NewFileFieldField instantiates a new FileFieldField object
...
// NewFileFieldFieldWithDefaults instantiates a new FileFieldField object
...
type NullableFileFieldField struct {
	value *FileFieldField
	isSet bool
}

func (v NullableFileFieldField) Get() *FileFieldField {
	return v.value
}

func (v *NullableFileFieldField) Set(val *FileFieldField) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFileFieldField(val *FileFieldField) *NullableFileFieldField {
	return &NullableFileFieldField{value: val, isSet: true}
}
