...
// checks if the SingleSelectFieldField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleSelectFieldField{}
...
// NewSingleSelectFieldField instantiates a new SingleSelectFieldField object
...
// NewSingleSelectFieldFieldWithDefaults instantiates a new SingleSelectFieldField object
...
type NullableSingleSelectFieldField struct {
	value *SingleSelectFieldField
	isSet bool
}

func (v NullableSingleSelectFieldField) Get() *SingleSelectFieldField {
	return v.value
}

func (v *NullableSingleSelectFieldField) Set(val *SingleSelectFieldField) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleSelectFieldField) IsSet() bool {
	return v.isSet
}
...
func NewNullableSingleSelectFieldField(val *SingleSelectFieldField) *NullableSingleSelectFieldField {
	return &NullableSingleSelectFieldField{value: val, isSet: true}
}
