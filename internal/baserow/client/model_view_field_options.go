...
type NullableViewFieldOptions struct {
	value *ViewFieldOptions
	isSet bool
}

func (v NullableViewFieldOptions) Get() *ViewFieldOptions {
	return v.value
}

func (v *NullableViewFieldOptions) Set(val *ViewFieldOptions) {
	v.value = val
	v.isSet = true
}
...
func NewNullableViewFieldOptions(val *ViewFieldOptions) *NullableViewFieldOptions {
	return &NullableViewFieldOptions{value: val, isSet: true}
}
