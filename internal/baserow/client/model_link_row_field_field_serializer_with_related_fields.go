...
// checks if the LinkRowFieldFieldSerializerWithRelatedFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkRowFieldFieldSerializerWithRelatedFields{}
...
// NewLinkRowFieldFieldSerializerWithRelatedFields instantiates a new LinkRowFieldFieldSerializerWithRelatedFields object
...
func NewLinkRowFieldFieldSerializerWithRelatedFields(id int32, tableId int32, name string, order int32, type_ string, readOnly bool, relatedFields []Field, linkRowRelatedFieldId NullableInt32, linkRowRelatedField int32) *LinkRowFieldFieldSerializerWithRelatedFields {
	this := LinkRowFieldFieldSerializerWithRelatedFields{}
	this.Id = id
...
// NewLinkRowFieldFieldSerializerWithRelatedFieldsWithDefaults instantiates a new LinkRowFieldFieldSerializerWithRelatedFields object
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) SetId(v int32) {
	o.Id = v
}

// GetTableId returns the TableId field value
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetTableId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetTableIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) SetTableId(v int32) {
	o.TableId = v
}

// GetName returns the Name field value
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) SetName(v string) {
	o.Name = v
}

// GetOrder returns the Order field value
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetOrder() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetOrderOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Order, true
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) SetOrder(v int32) {
	o.Order = v
}

// GetType returns the Type field value
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) SetType(v string) {
	o.Type = v
}

// GetPrimary returns the Primary field value if set, zero value otherwise.
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetPrimary() bool {
...
// and a boolean to check if the value has been set.
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetPrimaryOk() (*bool, bool) {
	if o == nil || IsNil(o.Primary) {
		return nil, false
	}
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) HasPrimary() bool {
	if o != nil && !IsNil(o.Primary) {
		return true
	}
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) SetPrimary(v bool) {
	o.Primary = &v
}

// GetReadOnly returns the ReadOnly field value
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetReadOnly() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetReadOnlyOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) SetReadOnly(v bool) {
	o.ReadOnly = v
}
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) GetLinkRowTable() int32 {
...
func (o *LinkRowFieldFieldSerializerWithRelatedFields) HasLinkRowTable() bool {
...
type NullableLinkRowFieldFieldSerializerWithRelatedFields struct {
	value *LinkRowFieldFieldSerializerWithRelatedFields
	isSet bool
}

func (v NullableLinkRowFieldFieldSerializerWithRelatedFields) Get() *LinkRowFieldFieldSerializerWithRelatedFields {
	return v.value
}

func (v *NullableLinkRowFieldFieldSerializerWithRelatedFields) Set(val *LinkRowFieldFieldSerializerWithRelatedFields) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkRowFieldFieldSerializerWithRelatedFields) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkRowFieldFieldSerializerWithRelatedFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkRowFieldFieldSerializerWithRelatedFields(val *LinkRowFieldFieldSerializerWithRelatedFields) *NullableLinkRowFieldFieldSerializerWithRelatedFields {
	return &NullableLinkRowFieldFieldSerializerWithRelatedFields{value: val, isSet: true}
}

func (v NullableLinkRowFieldFieldSerializerWithRelatedFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkRowFieldFieldSerializerWithRelatedFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
