...
// checks if the TextFieldField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TextFieldField{}
...
// NewTextFieldField instantiates a new TextFieldField object
...
// NewTextFieldFieldWithDefaults instantiates a new TextFieldField object
...
type NullableTextFieldField struct {
	value *TextFieldField
	isSet bool
}

func (v NullableTextFieldField) Get() *TextFieldField {
	return v.value
}

func (v *NullableTextFieldField) Set(val *TextFieldField) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTextFieldField(val *TextFieldField) *NullableTextFieldField {
	return &NullableTextFieldField{value: val, isSet: true}
}
