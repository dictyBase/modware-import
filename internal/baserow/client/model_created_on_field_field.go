...
// checks if the CreatedOnFieldField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatedOnFieldField{}
...
// NewCreatedOnFieldField instantiates a new CreatedOnFieldField object
...
// NewCreatedOnFieldFieldWithDefaults instantiates a new CreatedOnFieldField object
...
type NullableCreatedOnFieldField struct {
	value *CreatedOnFieldField
	isSet bool
}

func (v NullableCreatedOnFieldField) Get() *CreatedOnFieldField {
	return v.value
}

func (v *NullableCreatedOnFieldField) Set(val *CreatedOnFieldField) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatedOnFieldField) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreatedOnFieldField(val *CreatedOnFieldField) *NullableCreatedOnFieldField {
	return &NullableCreatedOnFieldField{value: val, isSet: true}
}
