...
// checks if the LastModifiedFieldCreateField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LastModifiedFieldCreateField{}
...
// NewLastModifiedFieldCreateField instantiates a new LastModifiedFieldCreateField object
...
func NewLastModifiedFieldCreateField(type_ Type712Enum) *LastModifiedFieldCreateField {
	this := LastModifiedFieldCreateField{}
	this.Type = type_
	return &this
}

// NewLastModifiedFieldCreateFieldWithDefaults instantiates a new LastModifiedFieldCreateField object
...
func (o *LastModifiedFieldCreateField) GetType() Type712Enum {
	if o == nil {
		var ret Type712Enum
		return ret
	}
...
func (o *LastModifiedFieldCreateField) SetType(v Type712Enum) {
	o.Type = v
}
...
type NullableLastModifiedFieldCreateField struct {
	value *LastModifiedFieldCreateField
	isSet bool
}

func (v NullableLastModifiedFieldCreateField) Get() *LastModifiedFieldCreateField {
	return v.value
}

func (v *NullableLastModifiedFieldCreateField) Set(val *LastModifiedFieldCreateField) {
	v.value = val
	v.isSet = true
}

func (v NullableLastModifiedFieldCreateField) IsSet() bool {
	return v.isSet
}

func (v *NullableLastModifiedFieldCreateField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLastModifiedFieldCreateField(val *LastModifiedFieldCreateField) *NullableLastModifiedFieldCreateField {
	return &NullableLastModifiedFieldCreateField{value: val, isSet: true}
}
