...
// checks if the PublicFormViewLogoImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicFormViewLogoImage{}
...
// NewPublicFormViewLogoImage instantiates a new PublicFormViewLogoImage object
...
// NewPublicFormViewLogoImageWithDefaults instantiates a new PublicFormViewLogoImage object
...
type NullablePublicFormViewLogoImage struct {
	value *PublicFormViewLogoImage
	isSet bool
}

func (v NullablePublicFormViewLogoImage) Get() *PublicFormViewLogoImage {
	return v.value
}

func (v *NullablePublicFormViewLogoImage) Set(val *PublicFormViewLogoImage) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicFormViewLogoImage) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicFormViewLogoImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicFormViewLogoImage(val *PublicFormViewLogoImage) *NullablePublicFormViewLogoImage {
	return &NullablePublicFormViewLogoImage{value: val, isSet: true}
}
