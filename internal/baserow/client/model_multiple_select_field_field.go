...
// checks if the MultipleSelectFieldField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultipleSelectFieldField{}
...
// NewMultipleSelectFieldField instantiates a new MultipleSelectFieldField object
...
// NewMultipleSelectFieldFieldWithDefaults instantiates a new MultipleSelectFieldField object
...
type NullableMultipleSelectFieldField struct {
	value *MultipleSelectFieldField
	isSet bool
}

func (v NullableMultipleSelectFieldField) Get() *MultipleSelectFieldField {
	return v.value
}

func (v *NullableMultipleSelectFieldField) Set(val *MultipleSelectFieldField) {
	v.value = val
	v.isSet = true
}

func (v NullableMultipleSelectFieldField) IsSet() bool {
	return v.isSet
}

func (v *NullableMultipleSelectFieldField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultipleSelectFieldField(val *MultipleSelectFieldField) *NullableMultipleSelectFieldField {
	return &NullableMultipleSelectFieldField{value: val, isSet: true}
}
