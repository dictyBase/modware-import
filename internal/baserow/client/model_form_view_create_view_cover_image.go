...
// checks if the FormViewCreateViewCoverImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormViewCreateViewCoverImage{}
...
// NewFormViewCreateViewCoverImage instantiates a new FormViewCreateViewCoverImage object
...
func NewFormViewCreateViewCoverImage(size int32, uploadedAt time.Time, url string, thumbnails map[string]interface{}, name string, originalName string) *FormViewCreateViewCoverImage {
	this := FormViewCreateViewCoverImage{}
	this.Size = size
...
// NewFormViewCreateViewCoverImageWithDefaults instantiates a new FormViewCreateViewCoverImage object
...
func (o *FormViewCreateViewCoverImage) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
type NullableFormViewCreateViewCoverImage struct {
	value *FormViewCreateViewCoverImage
	isSet bool
}

func (v NullableFormViewCreateViewCoverImage) Get() *FormViewCreateViewCoverImage {
	return v.value
}

func (v *NullableFormViewCreateViewCoverImage) Set(val *FormViewCreateViewCoverImage) {
	v.value = val
	v.isSet = true
}

func (v NullableFormViewCreateViewCoverImage) IsSet() bool {
	return v.isSet
}

func (v *NullableFormViewCreateViewCoverImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormViewCreateViewCoverImage(val *FormViewCreateViewCoverImage) *NullableFormViewCreateViewCoverImage {
	return &NullableFormViewCreateViewCoverImage{value: val, isSet: true}
}
