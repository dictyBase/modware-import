...
// checks if the RequestURLFieldUpdateField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestURLFieldUpdateField{}
...
// NewRequestURLFieldUpdateField instantiates a new RequestURLFieldUpdateField object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRequestURLFieldUpdateField() *RequestURLFieldUpdateField {
	this := RequestURLFieldUpdateField{}
	return &this
}

// NewRequestURLFieldUpdateFieldWithDefaults instantiates a new RequestURLFieldUpdateField object
...
func (o *RequestURLFieldUpdateField) GetType() Type712Enum {
...
func (o *RequestURLFieldUpdateField) SetType(v Type712Enum) {
	o.Type = &v
}
...
type NullableRequestURLFieldUpdateField struct {
	value *RequestURLFieldUpdateField
	isSet bool
}

func (v NullableRequestURLFieldUpdateField) Get() *RequestURLFieldUpdateField {
	return v.value
}

func (v *NullableRequestURLFieldUpdateField) Set(val *RequestURLFieldUpdateField) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestURLFieldUpdateField) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestURLFieldUpdateField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestURLFieldUpdateField(val *RequestURLFieldUpdateField) *NullableRequestURLFieldUpdateField {
	return &NullableRequestURLFieldUpdateField{value: val, isSet: true}
}
