...
// checks if the GridViewUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridViewUpdate{}
...
// NewGridViewUpdate instantiates a new GridViewUpdate object
...
// NewGridViewUpdateWithDefaults instantiates a new GridViewUpdate object
...
type NullableGridViewUpdate struct {
	value *GridViewUpdate
	isSet bool
}

func (v NullableGridViewUpdate) Get() *GridViewUpdate {
	return v.value
}

func (v *NullableGridViewUpdate) Set(val *GridViewUpdate) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGridViewUpdate(val *GridViewUpdate) *NullableGridViewUpdate {
	return &NullableGridViewUpdate{value: val, isSet: true}
}
