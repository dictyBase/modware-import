...
// checks if the LastModifiedFieldField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LastModifiedFieldField{}
...
// NewLastModifiedFieldField instantiates a new LastModifiedFieldField object
...
// NewLastModifiedFieldFieldWithDefaults instantiates a new LastModifiedFieldField object
...
type NullableLastModifiedFieldField struct {
	value *LastModifiedFieldField
	isSet bool
}

func (v NullableLastModifiedFieldField) Get() *LastModifiedFieldField {
	return v.value
}

func (v *NullableLastModifiedFieldField) Set(val *LastModifiedFieldField) {
	v.value = val
	v.isSet = true
}

func (v NullableLastModifiedFieldField) IsSet() bool {
	return v.isSet
}
...
func NewNullableLastModifiedFieldField(val *LastModifiedFieldField) *NullableLastModifiedFieldField {
	return &NullableLastModifiedFieldField{value: val, isSet: true}
}
