...
// checks if the KanbanViewUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KanbanViewUpdate{}
...
// NewKanbanViewUpdate instantiates a new KanbanViewUpdate object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewKanbanViewUpdate(slug string) *KanbanViewUpdate {
	this := KanbanViewUpdate{}
	this.Slug = slug
	return &this
}

// NewKanbanViewUpdateWithDefaults instantiates a new KanbanViewUpdate object
...
type NullableKanbanViewUpdate struct {
	value *KanbanViewUpdate
	isSet bool
}

func (v NullableKanbanViewUpdate) Get() *KanbanViewUpdate {
	return v.value
}

func (v *NullableKanbanViewUpdate) Set(val *KanbanViewUpdate) {
	v.value = val
	v.isSet = true
}
...
func NewNullableKanbanViewUpdate(val *KanbanViewUpdate) *NullableKanbanViewUpdate {
	return &NullableKanbanViewUpdate{value: val, isSet: true}
}
