...
// checks if the ExampleRowRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExampleRowRequest{}
...
// NewExampleRowRequest instantiates a new ExampleRowRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewExampleRowRequest() *ExampleRowRequest {
	this := ExampleRowRequest{}
	var field6 int32 = 0
	this.Field6 = &field6
...
// NewExampleRowRequestWithDefaults instantiates a new ExampleRowRequest object
...
type NullableExampleRowRequest struct {
	value *ExampleRowRequest
	isSet bool
}

func (v NullableExampleRowRequest) Get() *ExampleRowRequest {
	return v.value
}

func (v *NullableExampleRowRequest) Set(val *ExampleRowRequest) {
	v.value = val
	v.isSet = true
}
...
func NewNullableExampleRowRequest(val *ExampleRowRequest) *NullableExampleRowRequest {
	return &NullableExampleRowRequest{value: val, isSet: true}
}
