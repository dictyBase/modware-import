...
// checks if the DuplicateTableJobJob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DuplicateTableJobJob{}
...
// NewDuplicateTableJobJob instantiates a new DuplicateTableJobJob object
...
// NewDuplicateTableJobJobWithDefaults instantiates a new DuplicateTableJobJob object
...
type NullableDuplicateTableJobJob struct {
	value *DuplicateTableJobJob
	isSet bool
}

func (v NullableDuplicateTableJobJob) Get() *DuplicateTableJobJob {
	return v.value
}

func (v *NullableDuplicateTableJobJob) Set(val *DuplicateTableJobJob) {
	v.value = val
	v.isSet = true
}

func (v NullableDuplicateTableJobJob) IsSet() bool {
	return v.isSet
}
...
func NewNullableDuplicateTableJobJob(val *DuplicateTableJobJob) *NullableDuplicateTableJobJob {
	return &NullableDuplicateTableJobJob{value: val, isSet: true}
}
