...
// checks if the RequestRollupFieldUpdateField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestRollupFieldUpdateField{}
...
// NewRequestRollupFieldUpdateField instantiates a new RequestRollupFieldUpdateField object
...
func NewRequestRollupFieldUpdateField(nullable bool) *RequestRollupFieldUpdateField {
	this := RequestRollupFieldUpdateField{}
	this.Nullable = nullable
	return &this
}

// NewRequestRollupFieldUpdateFieldWithDefaults instantiates a new RequestRollupFieldUpdateField object
...
func (o *RequestRollupFieldUpdateField) GetName() string {
...
func (o *RequestRollupFieldUpdateField) GetType() Type712Enum {
...
func (o *RequestRollupFieldUpdateField) SetType(v Type712Enum) {
	o.Type = &v
}
...
func (o *RequestRollupFieldUpdateField) GetDateFormat() CountFieldCreateFieldDateFormat {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RequestRollupFieldUpdateField) GetDateFormatOk() (*CountFieldCreateFieldDateFormat, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RequestRollupFieldUpdateField) SetDateFormat(v CountFieldCreateFieldDateFormat) {
	o.DateFormat.Set(&v)
}
...
func (o *RequestRollupFieldUpdateField) GetArrayFormulaType() CountFieldCreateFieldArrayFormulaType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RequestRollupFieldUpdateField) GetArrayFormulaTypeOk() (*CountFieldCreateFieldArrayFormulaType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RequestRollupFieldUpdateField) SetArrayFormulaType(v CountFieldCreateFieldArrayFormulaType) {
...
func (o *RequestRollupFieldUpdateField) GetDateTimeFormat() CountFieldCreateFieldDateTimeFormat {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RequestRollupFieldUpdateField) GetDateTimeFormatOk() (*CountFieldCreateFieldDateTimeFormat, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RequestRollupFieldUpdateField) SetDateTimeFormat(v CountFieldCreateFieldDateTimeFormat) {
...
func (o *RequestRollupFieldUpdateField) GetNumberDecimalPlaces() CountFieldCreateFieldNumberDecimalPlaces {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RequestRollupFieldUpdateField) GetNumberDecimalPlacesOk() (*CountFieldCreateFieldNumberDecimalPlaces, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RequestRollupFieldUpdateField) SetNumberDecimalPlaces(v CountFieldCreateFieldNumberDecimalPlaces) {
...
type NullableRequestRollupFieldUpdateField struct {
	value *RequestRollupFieldUpdateField
	isSet bool
}

func (v NullableRequestRollupFieldUpdateField) Get() *RequestRollupFieldUpdateField {
	return v.value
}

func (v *NullableRequestRollupFieldUpdateField) Set(val *RequestRollupFieldUpdateField) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestRollupFieldUpdateField) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestRollupFieldUpdateField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestRollupFieldUpdateField(val *RequestRollupFieldUpdateField) *NullableRequestRollupFieldUpdateField {
	return &NullableRequestRollupFieldUpdateField{value: val, isSet: true}
}
