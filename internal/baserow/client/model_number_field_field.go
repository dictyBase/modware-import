...
// checks if the NumberFieldField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NumberFieldField{}
...
// NewNumberFieldField instantiates a new NumberFieldField object
...
// NewNumberFieldFieldWithDefaults instantiates a new NumberFieldField object
...
type NullableNumberFieldField struct {
	value *NumberFieldField
	isSet bool
}

func (v NullableNumberFieldField) Get() *NumberFieldField {
	return v.value
}

func (v *NullableNumberFieldField) Set(val *NumberFieldField) {
	v.value = val
	v.isSet = true
}
...
func NewNullableNumberFieldField(val *NumberFieldField) *NullableNumberFieldField {
	return &NullableNumberFieldField{value: val, isSet: true}
}
