...
// checks if the ExampleRowResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExampleRowResponse{}
...
// NewExampleRowResponseWithDefaults instantiates a new ExampleRowResponse object
...
func (o *ExampleRowResponse) GetField13() ExampleRowResponseField13 {
	if o == nil || IsNil(o.Field13.Get()) {
		var ret ExampleRowResponseField13
		return ret
	}
...
type NullableExampleRowResponse struct {
	value *ExampleRowResponse
	isSet bool
}

func (v NullableExampleRowResponse) Get() *ExampleRowResponse {
	return v.value
}

func (v *NullableExampleRowResponse) Set(val *ExampleRowResponse) {
	v.value = val
	v.isSet = true
}
...
func NewNullableExampleRowResponse(val *ExampleRowResponse) *NullableExampleRowResponse {
	return &NullableExampleRowResponse{value: val, isSet: true}
}
