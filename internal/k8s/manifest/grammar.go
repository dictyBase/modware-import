...
func Adverb() []string {
	...
	for _, fn := range []strSliceFnT{adverbFragOne, adverbFragTwo, adverbFragThree, adverbFragFour, adverbFragFive} {
		adverbs = append(adverbs, fn()...)
	}

	return adverbs
}

func adverbFragFive() []string {
	return []string{
